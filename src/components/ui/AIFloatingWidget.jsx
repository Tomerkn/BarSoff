  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <div className="bg-[var(--color-brand)] p-3 flex justify-between items-center text-white rounded-t-2xl shrink-0"> {/* הפס העליון (ללא גרירה כרגע בגלל באג ב-React 19) */}
            <div className="flex items-center gap-2">
              <Bot className="w-5 h-5" />
              <span className="font-bold text-sm">התייעץ עם ברבור</span>
            </div>
            <button 
